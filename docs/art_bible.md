...
- **Enemies:** hunched/bestial shapes vs. the party's upright ones; elites
  ...
  **86 sprites — 27 normal + 37 elite at 24×24, 22 bosses at 36×36**
  (M84 added the 7 Guild Masters and their 12 courts under the same §5/§5b
  rules) — generated by `generate_textures.ps1`; a presentation-lint guard
