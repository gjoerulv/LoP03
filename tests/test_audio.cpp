...
TEST_CASE("every shipped audio file is a valid PCM16 mono 22050 Hz WAV", "[audio]") {
    ...
    CHECK(files == 49);  // 12 music (incl. dungeon_goosy, 2026-08-17) + 6 town-ladder (M32) + 2 castle/king (M40) + 1 duck (M62) + 1 mock jingle (M112) + 5 ambience (incl. goosy) + 22 sfx (15 + the M91 elemental impacts + the M107 summon arrival)
}
