...
description: Operational workflow for building "Are P Geese" (formerly Crystal Dungeons), a 16-bit-inspired turn-based JRPG roguelite in C++20 / raylib / CMake. Use when implementing any milestone, building, testing, validating, or making design/architecture decisions for this project.
---
...
milestone through 2026-08-07. **M86–M97** (CrystalForge catch-up, the
0.9.0 → 0.6.0 renumber, the M87 text containers, and the M88–M97
...
v22, battle rules v18, version **0.7.0**, capture set **124 scenes**,
matrix rows 185–204; the 2026-08-17 fix rounds added the real Goosy
art/audio, reel icons, the true title-screen rebrand, and the v22 rite
leveling) is
`implemented, awaiting manual approval` — the ledger in
